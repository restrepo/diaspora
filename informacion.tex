...
La materia oscura, siendo la materia dominante, con cerca de 25\% de la densidad de energía del Universo, representa un gran desafío teórico y experimental, tanto para la astrofísica moderna como para la física de partículas \cite{Bertone:2004pz, Amsler:2008zzb, Bertone:2010,Jungman:1995df}. En la actualidad no sabemos cuál es su verdadera identidad y no se tiene ninguna explicación en la teoría que rigen las interacciones de las partículas fundamentales, el Modelo Estándar.

Muchos esfuerzos teóricos se han realizado para construir teorías más allá del Modelo Estándar con candidatos prometedores de materia oscura. Entre los candidatos a ser una partícula masiva débilmente interactuante \cite{Bertone:2004pz,Jungman:1995df} (no bariónica, lo suficientemente estable y neutra eléctricamente), tenemos la más ligera de las partículas supersimétricas, escalares neutros adicionales, neutrinos derechos, y las partículas de Kaluza-Klein, cada uno con diferentes implicaciones experimentales. 
...
En los últimos tres años, ha habido un gran interés en los datos registrados por los distintos experimentos de rayos cósmicos en el rango de energía del orden de cientos de GeV y con una precisión sin precedentes. Los resultados experimentales muestran un exceso inesperado en comparación con el background convencional, tanto en el flujo de electrones más positrones como en la fracción de positrones, señalando la existencia de una fuente adicional de electrones y positrones en el halo de la Vía Láctea, mientras que los datos de antiprotones están de acuerdo con el background astrofísico esperado. El satélite PAMELA mostró un aumento en la fracción de positrones  con energías desde 10 hasta 100 GeV \cite{Adriani:2008zr}, el experimento ATIC reportó el descubrimiento de un pico en el flujo total de electrones más positrones a una energía de 600-700 GeV \cite{:2008zzr} y más recientemente el satélite FERMI midió el flujo total de electrones más positrones de 20 GeV a 1 TeV \cite{Abdo:2009zk} con una precisión muy alta, reportando un exceso en el rango de energía igual ATIC, pero menos pronunciada \cite {Bergstrom:2009fa,Balazs:2009wm,Ibarra:2009dr}. 
%Estos hallazgos, además de los publicados por HESS \cite{Collaboration:2008aaa}, HEAT \cite{Barwick:1997ig,Duvernois:2001bb}, CAPRICE \cite{2000ApJ...532..653B}, AMS-01 \cite{Aguilar:2007yf, Aguilar:2002ad}, BETS \cite{Torii:2001aw} y PPB-BETS \cite{Torii:2008xu} podrían estar indicando la presencia de una fuente cercana de electrones y positrones. 
A finales de 2008, junto con la publicación de datos de la fracción de positrones, PAMELA \cite{Adriani:2008zq} reveló los resultados de la proporción de antiprotones sobre protones, en acuerdo con los modelos de propagación convencional. 
%Estos resultados se suman a los experimentos realizados durante los últimos 15 años: BESS \cite{Asaoka:2001fv} y HEAT \cite{Beach:2001ub}, BESS95 \cite{Matsunaga:1998he}, BESS 95/97 \cite{Orito:1999re}, CAPRICE94 \cite{Boezio:1997ec}, CAPRICE98 \cite{Boezio:2001ac} e IMAX \cite{Mitchell:1996bi}. 
Las mediciones recientes realizadas por el Telescopio FERMI \cite{Abdo:2010nz}, en el rango de energía de 0.2 a 100 GeV, del espectro difuso de rayos gamma  extragaláctico no han demostrado el exceso de energías entre 1 y 10 GeV reportado por la colaboración del satélite EGRET \cite{Sreekumar:1997un}.
