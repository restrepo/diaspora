...
partículas adicionales al modelo supersimétrico~\cite{}.  En modelos
supersimétricos con violación bilineal de paridad R también es posible
explicar las masas y mezclas de neutrinos
\cite{Hirsch:2004he,Hirsch:2008ur}. Por un lado se encuentra la
...
masas para neutrinos. También hemos explorado~\cite{} la intersección en
...
materia oscura especialmente interesante pues genera predicciones en
la tres fronteras de las física de partículas y la cosmología que se
han venido confrontando con los resultados experimentales muy
diversos.
...
\begin{proyecto}
  ...
  y la vez generen masas para los neutrinos?
\end{proyecto}
