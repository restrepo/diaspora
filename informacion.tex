...
el esfuerzo experimental para dilucidar los misterios cruciales de nuestro
...
neutrinos. A éste tipo de modelos se aplicarán restricciones
...
mundiales es usada en estos momentos por la comunidad de física de
...
Grupo~\cite{Nardi:2008ix,Sierra:2009zq}. Las medidas cada vez más
...
descartaría completamente este mecanismo de generación de
...
También hemos explorado~\cite{Restrepo:2011rj} la intersección en las
tres fronteras encontrando la restricciones en el modelo BRpV
provenientes de las medidas de líneas de rayos gamma obtenidas por
Fermi cuando el gravitino es la partícula supersimétrica más liviana y
da cuenta de la materia oscura del Universo. Como los acoplamientos
que violan paridad R deben ser suficientemente grandes para explicar
masas y mezclas de neutrinos, los decaimientos que violan paridad R de
la partícula supersimétrica siguiente a la más liviana (NLSP) dominan
...
experimentales muy diversos. Es así como por ejemplo se ha logrado
restringir hasta en 12 órdenes de magnitud el tiempo de vida media del
gravitino, desde los $10^{17}$ s (correspondientes a la edad del
Universo) hasta los $10^{29}$ s, en el rango de masas alrededor de
10~GeV, cuando el gravitino decae dominantemente a
...
\begin{gravitinodm}
  ...
  cuando los operadores trilineales son usados para generar las masas y
...
Escuela de Ingeniería de Antioquia       &                              &$\EFP{21000000}\xdef\Dc{\RR}$       &$\EFP{Dc}\xdef\Dd{\RR}$\\\hline
Coinvestigador (10h/semana): Contrapartida
...
Matemáticas (Rack 7 nodos)               &$\EFP{0}\xdef\Kb{\RR}$        &$\EFP{100000000}\xdef\Kc{\RR}$&$\EFP{(Kb+Kc)}\xdef\Kd{\RR}$\\\hline
