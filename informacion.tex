...
Estudiar sistemáticamente los modelos supersimétricos con violación bilineal de paridad R y con el gravitino como materia oscura, que sean capaces de explicar la fenomenología de las oscilaciones de neutrinos, cuando no se tienen en cuenta $i)$ la leptogénesis estándar, y $ii)$ la universalidad de las masas de los gauginos. 
\subsection{Objetivos específicos}
\begin{itemize}
\item Estudiar cuales serían las implicaciones en física de neutrinos cuando no se consideran las restricciones de leptogénesis en los modelos supersimétricos con violación bilineal de paridad R y con el gravitino como materia oscura. 
\item Determinar las restricciones que imponen las recientes medidas de la emisión extragaláctica para los acoplamientos bilinelaes en los modelos con rutura bilineal de paridad R y con el gravitino como materia oscura, una vez se haya abandonado la condición de universalidad de las masas de los gauginos.
\item Estudiar la generación de las masas y mezclas de los neutrinos en los modelos supersimétricos con violación bilineal de paridad R y con el gravitino como materia oscura
\item Determinar cuales serían las señales en aceleradores de los modelos supersimétricos con violación bilineal de paridad R y con el gravitino como materia oscura cuando se asume la no universalidad de las masas de los gauginos y se desprecian las restricciones provenientes de leptogénesis.
\end{itemize}
...
La propuesta metodológica para desarrollar este proyecto tiene las siguientes fases:
\begin{enumerate}
\item Considerar el Modelo Estándar supersimétrico sin conservación de la simetría paridad R.
\item Entre los diferentes modelos supersimétricos con rotura bilineal de paridad R establecer aquellos modelos donde el gravitino sea el candidato a materia oscura. Esto es, establecer aquellos modelos bilineales donde el gravitino es la partícula supersimétrica más ligera y que posea un tiempo de vida mucho mayor a la edad del Universo. 
\item Calcular el tiempo de vida del gravitino en función de la masa del gravitino y de los acoplamientos bilineales.  
\item Obtener las restricciones sobre el tiempo de vida del gravitino provenientes de la búsqueda de líneas de rayos gamma realizada a partir de los datos reportados por las colaboraciones EGRET y FERMI. 
\item Determinar cuál es la densidad de materia oscura de gravitinos en el rango de masas de gravitino $10^{-5}\lesssim m_{\tilde G}\lesssim 10$ GeV, en función de las masas de los gauginos, la temperatura de recalentamiento y la masa del gravitino. En este punto, se debe tener en cuenta que debido a las débiles interacciones del gravitino, éste no se encuentra en equilibrio térmico con el plasma primordial.
\item Obtener la expresión para las masas de los neutrinos, generadas por los términos bilineales que violan paridad R.
\item Establecer cuál es la relación entre la densidad reliquia de gravitinos, el tiempo de vida de los gravitinos y las masas de los neutrinos. 
\item Determinar las implicaciones en la física de neutrinos cuando no se asume la universalidad de las masas de los gauginos. Para este fin, se tomaran valores degenerados y muy jerárquicos para las masas del bino $M_1$ y el wino $M_2$.
\item Una vez se permitan valores bajos de la temperatura de recalentamiento $T_R<10^9$ GeV (esto es, relajando la condición de leptogénesis), determinar las implicaciones en la física de neutrinos.
\item Considerar los decaimientos de la segunda partícula supersimétrica más ligera, que involucren a los bosones vectortiales en los estados finales, con el fin de establecer cuáles serían las señales en aceleradores cuando se asume la no universalidad de las masas de los gauginos y se desprecian las restricciones provenientes de leptogénesis.
\end{enumerate}
...
\begin{proyecto}
  ...
  hadrónicamente. 
%   \begin{soloproyecto}
% En dicho código, es necesario reconstruir la masa
