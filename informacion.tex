...
modelo de nueva física, usando como paradigma el modelo con ruptura
bilineal de paridad R y ejemplificando cada paso con referencias
concretas.
\begin{enumerate}
\item Se construye un modelo que solucione un problema fenomenológico
  ...
  \cite{Hirsch:2005ag,Diaz:2003as}), mostrando bajo que mecanismo
...
\item Se determina el espacio de parámetros compatible con los datos
  ...
  experimentos de detección directa e indirecta
  \cite{Choi:2010xn,Diaz:2003as}.
  \label{item:6}
