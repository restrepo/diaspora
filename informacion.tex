...
consideradas como estables, aunque es cierto que también podrían ser
...
La siutación experimental está lejos de ser sencilla, ya que por el momento
...
constituye un candidato viable de materia oscura estable escalar con implicaciones en aceleradores~\cite{} y
en experimentos de detección directa~\cite{Sierra:2008wj} e
indirecta~\cite{0909.2799} de materia oscura. En el caso de la
extensión del modelo estándar con un doblete inerte se puede tener una
conexión con la frontera de intensidad si se adicionan neutrinos
derechos impares bajo la simetría $Z_2$. A diferencia del mecanismo
seesaw tradicional para generar masas y mezclas para los neutrinos
ligeros, en este caso las masas de neutrinos ligeros se generan a un
loop de modo que los neutrinos derechos pueden estar en la escala del
TeV con sus correspondientes acoplamientos de Yukawa suficientemente
grandes como para ser producidos en el LHC~\cite{}
...
%Correlaciones entre la diferentes fronteras.
